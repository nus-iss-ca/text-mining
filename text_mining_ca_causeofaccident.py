...
#read data
os.chdir("C:\\Users\\Jasmine\\Desktop\\TextMining\\CA\\Folder_SLFiles")
m_df = pd.read_csv("MsiaAccidentCases_edited.csv")
...
for counter in range(1,11):
    ...
    # Train the SVM
    sv = train_svm(train_vectors, m_df_train['Cause '])
...
o_df_test.to_csv('osha_classified.csv')
